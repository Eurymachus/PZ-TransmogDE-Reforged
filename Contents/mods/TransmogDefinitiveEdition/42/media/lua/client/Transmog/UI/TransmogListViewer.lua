...
function TransmogListViewer:initialise()
    if not self._initialised then
        ...
        self.reset = ISButton:new(self:getWidth() - (UI_BORDER_SPACING + 1) - btnWid,
            self:getHeight() - UI_BORDER_SPACING - BUTTON_HGT - 1, btnWid, BUTTON_HGT,
            getText("IGUI_WorldMapEditor_Reset"), self, TransmogListViewer.onClickTransmog);
        ...
        self.hideItem = ISButton:new(self:getWidth() - (UI_BORDER_SPACING + 1) - btnWid - (UI_BORDER_SPACING + 1) -
                                         self.reset.width, self:getHeight() - UI_BORDER_SPACING - BUTTON_HGT - 1,
            btnWid, BUTTON_HGT, getText("IGUI_TransmogDE_ListViewer_Hide"), self, TransmogListViewer.onClickTransmog);
        ...
        self.showItem = ISButton:new(self:getWidth() - (UI_BORDER_SPACING + 1) - btnWid - (UI_BORDER_SPACING + 1) -
                                         self.reset.width, self:getHeight() - UI_BORDER_SPACING - BUTTON_HGT - 1,
            btnWid, BUTTON_HGT, getText("IGUI_TransmogDE_ListViewer_Show"), self, TransmogListViewer.onClickTransmog);
